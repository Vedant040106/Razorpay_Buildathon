...
export function MetricsSection() {
  const metrics = [
    ...
    {
      counter: <AnimatedCounter target={4000} duration={1200} suffix="ms" />,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {metrics.map((m, i) => (
            <ScrollReveal
              ...
              className="h-full"
            >
              <div className="h-full p-5 bg-white border border-slate-200 rounded-xl text-center shadow-xs hover:-translate-y-0.5 transition-transform duration-200">
