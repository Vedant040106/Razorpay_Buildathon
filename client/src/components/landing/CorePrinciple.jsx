      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
          ...
          <ScrollReveal animation="fade-up" delay={0} duration={600}>
            <div className="h-full p-6 bg-slate-50 border border-slate-200 rounded-xl relative group hover:border-slate-300 transition">
          ...
          {/* Stage 2: Policy (Stronger Emphasis) */}
          <ScrollReveal animation="fade-up" delay={120} duration={650}>
            <div className="h-full p-6 bg-indigo-50/60 border-2 border-indigo-300 rounded-xl relative group shadow-sm ring-1 ring-indigo-200/50">
              ...
              <div className="text-xs font-mono font-bold text-indigo-700 uppercase">Stage 02 • Core Gate</div>
